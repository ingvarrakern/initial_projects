    ...
    <body>
        <div class="bd-content ps-lg-4 col-lg-4">
            <form method="POST" action="LoginController.php">
                ...
                <button type="submit" class="btn btn-primary" href="LoginController.php" target="target"> login</button>
            </form>
        </div>
        <div class="bd-content ps-lg-4 col-lg-4 mt-3">
            <a type="button" class="btn btn-primary" href="registration.php" target="target"> Registration</a> 
        </div>
